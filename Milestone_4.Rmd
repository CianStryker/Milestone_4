...
While the authors decided to run OLS linear regressions measuring the effect various variables had on Uzbeks behavior in the Prisoner's Dilema and Dictator Game I decided to run the same testing but for their Kyrgyz subjects. This shows the differnces between the two ethnic groups and suggests some intersting differnces to how Uzebeks reacted to the riots and how Kyrgyz reacted who were not the target of the riots, but who were still saw damaged and/or destroyed property. 
